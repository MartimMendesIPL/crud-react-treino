...
export default function ProposalItemsPage() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    api
      .get<ProposalItem[]>(`/proposal-items?proposal_id=${id}`)
      .then((data) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setDeleteId(null);
      load();
      sileo.success({ title: t("admin.crud.deleteSuccess") });
    } catch (e: unknown) {
      sileo.error({
          ...
          <table className="crud-table">
            ...
            <tbody>
              {items.map((item) => (
                <tr key={item.id}>
                  <td>{item.id}</td>
                  <td>{resolveProductName(item.product_id)}</td>
                  <td>{item.quantity}</td>
            ...
            <div className="crud-modal-body">
              ...
              <div className="crud-field">
                ...
                <AsyncSelect<SelectOption>
                  ...
                  placeholder={t("admin.proposals.searchProduct")}
                  isClearable

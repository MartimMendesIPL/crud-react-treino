        ...
        <div className="stat-kpi-card">
            ...
            {(subtitle || trendLabel) && (
                <div className="stat-kpi-footer">
                    ...
                    {subtitle && (
                        <span className="stat-kpi-subtitle">{subtitle}</span>
                    )}
                </div>
            )}
        </div>
...
export default function StatisticsPage() {
    ...
    useEffect(() => {
        api.get<StatsResponse>("/statistics")
            .then(setStats)
            .catch(() => {})
    ...
    const summaryRows = [
        ...
        },
        {
            ...
            value:
                stats.orders_by_status.find((s) => s.status === "pending")
                    ?.count ?? 0,
        },
        {
    ...
    return (
        <div className="stat-page">
            ...
            <div className="stat-charts-grid">
                ...
                <ChartCard
                    title={t("admin.statistics.ordersByStatus")}
                    icon={PieChart}
                >
                ...
                <ChartCard
                    title={t("admin.statistics.summary")}
                    icon={BarChart3}
                >
